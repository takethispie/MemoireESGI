...
%contrairement au deep learning le RDL peut supporter une certaines quantité de noise dans ses information
%alors que le deep learning doit avoir identifié ses features précisément, le RDL peut se contenté d'information
%partielles (ce qui se rapproche curieusement du fonctionnement de la reflexion humain par ailleurs
%ou il nous arrive de faire des inférence logique à partir d'information incomplète ex:
%les feuilles d'arbres bougent = il y a du vent et pourtant nous n'avons pas encore verifié de manière 
%factuelle la présence de vent 
