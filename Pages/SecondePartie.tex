...
\section{La problématique de l'automatisation des métiers}
    ...
    \subsection*{La resistance au changement forte avec l'IA}
        ...
        La quatrième, loi DIR ou Directe s'active dans le cas de disfonctionnement majeur qui touche 
        l'ensemble des systèmes de l'appareil, toutes les sécurités se désactive et le contrôle 
        au manche n'est plus amortis.
        \newline
        ...
        pilote automatique et est passé en loi alternative 2 
