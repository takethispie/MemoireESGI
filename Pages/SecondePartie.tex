...
\section{La problématique de l'automatisation des métiers}
    ...
    \begin{itemize}
        \item Le coût: le développement d'intelligences artificelles reste très coûteux car il est difficile 
            de poser des limite fix contrairement au développement d'algorithme ou il est bien plus facile 
            ...
            encore plus le budget nécéssaire.
            \newline

        \item Gestion / Management de Projet: était un domaine encore récent, les projets incluant 
            de l'intelligence artificielle sont plus complexe à gérer à cause de l'effet buzzword, 
            les prérequis nécéssaires (type de réseau, pureté des données d'entraînement et même 
            la pertinance réelle de l'utilisation de l'IA), mais les dangers d'une mauvaise gestion
            de projet sont les mêmes qu'avec un projet de développement traditionnel. 
            \newline 
